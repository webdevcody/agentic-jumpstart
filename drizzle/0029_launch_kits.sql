...
--> statement-breakpoint
ALTER TABLE "app_launch_kit" ADD CONSTRAINT "app_launch_kit_author_id_app_user_id_fk" FOREIGN KEY ("author_id") REFERENCES "public"."app_user"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "launch_kits_author_idx" ON "app_launch_kit" USING btree ("author_id");--> statement-breakpoint
...
CREATE INDEX "launch_kits_created_idx" ON "app_launch_kit" USING btree ("created_at");--> statement-breakpoint
...
CREATE INDEX "launch_kit_analytics_user_idx" ON "app_launch_kit_analytics" USING btree ("user_id");