...
CREATE INDEX "blog_post_views_created_idx" ON "app_blog_post_view" USING btree ("created_at");--> statement-breakpoint
CREATE UNIQUE INDEX "blog_post_views_session_post_unique" ON "app_blog_post_view" USING btree ("sessionId","blogPostId");--> statement-breakpoint
...
CREATE INDEX "blog_posts_created_idx" ON "app_blog_post" USING btree ("created_at");