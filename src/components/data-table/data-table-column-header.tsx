...
export function DataTableColumnHeader<TData, TValue>({
  ...
  const isRightAligned = className?.includes("ml-auto");
    ...
    <DropdownMenu>
      <DropdownMenuTrigger
        className={cn(
          ...
          !isRightAligned && "-ml-1.5",
          isRightAligned && "-mr-1.5",
          className,
        )}
        {...props}
      >
      ...
      <DropdownMenuContent align={isRightAligned ? "end" : "start"} className="w-28">
        {column.getCanSort() && (
          <>
            <DropdownMenuCheckboxItem
