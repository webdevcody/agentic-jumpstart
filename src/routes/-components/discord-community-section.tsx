      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-12">
        <div className="text-center mb-16">
          ...
          <ScrollAnimation direction="up" delay={0.2}>
            <p className="text-description mb-12 max-w-4xl mx-auto text-lg">
              Connect with thousands of AI developers, share your projects, get instant help, 
              and stay updated on the latest agentic coding techniques. Our community is 
              active 24/7 and completely free to join.
            </p>
          </ScrollAnimation>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-16">
          <ScrollScale delay={0.3}>
            <CommunityHighlight
              icon={<Users className="w-8 h-8 text-green-500 group-hover:text-green-400 group-hover:scale-110 transition-all duration-300" />}
              title="5,000+ Members"
          ...
          <ScrollScale delay={0.4}>
            <CommunityHighlight
              icon={<MessageCircle className="w-8 h-8 text-green-500 group-hover:text-green-400 group-hover:scale-110 transition-all duration-300" />}
          ...
          <ScrollScale delay={0.5}>
            <CommunityHighlight
              icon={<Heart className="w-8 h-8 text-green-500 group-hover:text-green-400 group-hover:scale-110 transition-all duration-300" />}
        ...
        <ScrollAnimation direction="up" delay={0.6}>
          <div className="text-center">
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              ...
              >
                <Button size="lg" className="text-lg px-8 py-4 h-auto group bg-green-600 hover:bg-green-700 dark:bg-green-600 dark:hover:bg-green-700">
...
function CommunityHighlight({ icon, title, description }: CommunityHighlightProps) {
  return (
